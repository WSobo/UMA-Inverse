...
def main() -> None:
    ...
    _run(["uv", "run", "python", "scripts/paper/figures/fig5_pocket_distal.py"])
    _run(["uv", "run", "python", "scripts/paper/figures/fig6_cofold.py"])
