...
def main() -> None:
    ...
    print("  python LigandMPNN/run.py \\")
    print("    --model_type ligand_mpnn \\")
    print(f"    --pdb_path_multi {pdb_path_json} \\")
    print(f"    --fixed_residues_multi {fixed_residues_json} \\")
    print("    --out_folder outputs/preprint/ligandmpnn_pocket_fixed \\")
    print("    --batch_size 4 --number_of_batches 5 \\")
