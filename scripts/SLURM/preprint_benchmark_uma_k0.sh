...
#
# Output: outputs/benchmark/v3-gibbs-K0/gibbs_sweep.csv
...
echo ">> Results: outputs/benchmark/v3-gibbs-K0/gibbs_sweep.csv"
cat outputs/benchmark/v3-gibbs-K0/gibbs_sweep.csv
