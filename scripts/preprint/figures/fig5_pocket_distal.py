...
def main() -> None:
    ...
    if not args.summary.exists():
        raise SystemExit(
            f"missing {args.summary}. Run scripts/preprint/compute_pocket_fixed_metrics.py "
    ...
    for col, split_filter, split_name in ((0, "small_molecule", "Small molecule"),
        ...
        for u, l in zip(uma_div, lig_div):
            ax.plot([0, 1], [u, l], color="#888", alpha=0.5, linewidth=0.7)
