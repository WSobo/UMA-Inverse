...
Code, training and evaluation scripts, and the trained checkpoint are released at
\href{https://github.com/WSobo/UMA-Inverse}{\texttt{github.com/WSobo/UMA-Inverse}}; the weights are
hosted on the Hugging Face Hub
(\href{https://huggingface.co/WSobo/UMA-Inverse}{\texttt{huggingface.co/WSobo/UMA-Inverse}}) and are
auto-fetched on first use. An interactive demo --- a CPU-hosted web UI and REST API serving the model
--- is available at
\href{https://huggingface.co/spaces/WSobo/uma-inverse}{\texttt{huggingface.co/spaces/WSobo/uma-inverse}}.
The LigandMPNN training split is available at
